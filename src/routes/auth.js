...
const { register, login, updateProfile, getProfile, wakeup, checkUserExists, validateInvitationToken, registerWithInvitation } = require('../controllers/authController');
